...
In particular the purpose of the following pages is to explain the basic characteristics of the engine control strategies and to show in details the sequence of actions to perform HDS :term:`ECU` calibration on engine/vehicle using toolset and SW operating under Windows |copy|
...
*	Section I provides general information on HDS, suggested instrumentation and fitting of HDS :term:`ECU` and other Metatron components, general information on used toolset and SW,

*	Section II provides detailed information to perform :term:`ECU` base calibration on engine dyno.
