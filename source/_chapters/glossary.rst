...
.. glossary::
    ...
    TDC
        Top Dead Center - The engine angular location when a piston reach the uppermost position (closest to cylinder head) in a cylinder. In 4 strokes engine TDC is reached twice per cycle, end of compression and end of exhaust phases. By default TDC refers to the first of the two, the end of intake phase, since it is the active phase of the combusion cycle when the combustion is normally already started. Also called the firing TDC.
